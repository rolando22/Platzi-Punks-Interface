            ...
            <form onSubmit={submit}>
                <FormControl>
                    <InputGroup>
                        ...
                        <Input isInvalid={false} value={address ?? ""} onChange={handleAddressChange} placeholder="Buscar por dirección" />
                        <InputRightElement width="5.5rem">
                            <Button type="submit" h="1.75rem" size="sm">Buscar</Button>
                        </InputRightElement>
                    </InputGroup>
                    {submitted && !validAddress && (<FormHelperText>Direncción inválida</FormHelperText>)}
                </FormControl>
            </form>
            {loading ? (
                <Loading />
